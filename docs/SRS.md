...
| Вход зарегистрированного пользователя | Система предоставляет поле для ввода имени пользователя. В случае, если пользователь аналитик, запрашивается активатор |
...
| Изменение видиотеки| Добавление новых видео в тренировачный набор |
