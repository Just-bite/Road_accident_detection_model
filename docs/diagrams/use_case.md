...
Веб-сервер | Удаленный сервер для аутентификации пользователей
Локальная БД | База данных на ПК для хранения отчетов и настроек
...
3. Пользователь нажимает "Config";
