...
4. Пользователь вводит активатор (опционально);
5. Пользователь подтверждает регистрацию;
6. Приложение проверяет активатор. Если активатор невалидный, выполняется А3;
7. Приложение создает учетную запись с соответствующими правами;
8. Приложение скрывает окно регистрации;
9. Приложение отображает главное меню;
